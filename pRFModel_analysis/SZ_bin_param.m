function [data,b_upper_plot,b_lower_plot,b_xfit,b_y] = SZ_bin_param(x_param,y_param,w,xfit,opt)
    ...
    case {'Eq_size'}
       ...
       bins = ceil(num_bin*floor(tiedrank(x_param))./length(x_param));
        ...
        if c>0
            ...
            data.ysterr(idx_zero) = mean([data.ysterr(idx_zero-1),data.ysterr(idx_zero+1)],2); % if there
        end
