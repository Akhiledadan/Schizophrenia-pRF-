function model_data_thr =  SZ_params_thr(model_data,thr_index,opt)
...
model_data_thr.sigmaFWHM = model_data.sigmaFWHM(thr_index);
...
%     model_data_thr.DoGs_beta1 = model_data.DoGs_beta1(thr_index);
%     model_data_thr.DoGs_beta2 = model_data.DoGs_beta2(thr_index);
    model_data_thr.DoGs_suppressionIndex = model_data.DoGs_suppressionIndex(thr_index);
