...
%for i = 1:numOfM
    ...
    parametersData{i}.sigma = rmGet(rmData.model{1}, 'sigmamajor');
    ...
    betaTmp = rmGet(rmData.model{1}, 'beta');
    parametersData{i}.beta = betaTmp;
    parametersData{i}.betaDC = betaTmp(1,:,2);
