...
for cond_idx = 1:numCond
    ...
    switch cur_cond
        case 'ptH'
            ...
            %subjects = [{'100','101','102','103','104','106','109','110','111','112','114'}];%ORIGINAL
            ...
            %                         subjects = [{'100','102','103','106','109','110','111','112'}];
            
        case 'ptNH'
            
            subjects = opt.subjects.ptNH;
            
            % subjects = [{'200','201','202','203','204','205','206','207','208','209','210','211','212','218'}];%ORIGINAL
            
            %            subjects = [{'200'}];                       
            %            subjects = [{'200','201','202','203','204','205','206','207','210','211'}];
            %            subjects = [{'200','201','202','203','204','205','206','207','208','210','211','218'}];
            
        case 'HC'
            
            subjects = opt.subjects.HC;
            
            % subjects = [{'301','302','304','305','306','307','309','310','312','313','314','315','316'}];%ORIGINAL
            ...
            %            subjects = [{'306','307','309','310','315','316'}];            
    end
    ...
    for sub_idx = 1:length(subjects)
        ...
        for roi_idx = 1:num_roi
            roi_fname{cond_idx,sub_idx,roi_idx} = fullfile(dirPth.roi_path,strcat(rois{roi_idx},'.mat'));
        end
