...
% SZ_NWayAnova - one way ANOVA to comapre between groups
% 
% inputs - params: parameter to compare (sigma_1G, surround size etc)
%          opt   : variable containing different options generated by
%                  SZ_getOpts.m function 
%          stats_folder: folder where the central and AUC values are
%                        saved from the SZ_pRFAnalysis.m function
%
% output - Function spits displays the p values and F value. 
